...
JULY 2025 NEW FRESH START

- delete all the stuff you are not using
- hide the stuff you might use but cluttering rn and LABEL IT in the html
- Consider your home page
- Add the Garden
- Add sketchbook
- Add ad page, which will be the holding page also


- Code Home page
- Code 404
- Code About Page
- Code All Project Pages (do this in school)
- Add Resume
- 
